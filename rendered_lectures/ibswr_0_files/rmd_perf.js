...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 22 }, { marker: 'pandoc', elapsed: 76 }, { marker: 'post-processor', elapsed: 80 }, { marker: 'pre-processor', elapsed: 4 }, { marker: 'render', elapsed: 379 } ];
