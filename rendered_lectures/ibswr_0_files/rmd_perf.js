...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 19 }, { marker: 'pandoc', elapsed: 65 }, { marker: 'post-processor', elapsed: 69 }, { marker: 'pre-processor', elapsed: 5 }, { marker: 'render', elapsed: 317 } ];
