...
sidebarPanel(actionButton("start_CP", "Start"), hr(),
  ...
  sliderInput("wait_timeCP", label = "Wait time:",
              min = 100, max = 1000, value = 1000, step = 100), width = 2)
...
Markov Chain Monte Carlo (MCMC) **Rosenbluth**$\times$**2, Teller**$\times$**2, Metropolis (1953); Hastings  (1970)**
...
<div>
Faster, more computationally efficient alternatives
