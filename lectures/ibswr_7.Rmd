...
<div>
<div id=hidestuff style="float: right; clear: right;"><span class="code">base R</span> <img src="./isarfiles/files/R_logo.png" alt="" height=50px></div>
...
brmfit_diamonds <- brm(bf(log_Price ~ log_Carats*(Color + Clarity)), diamond_data) # run the model
```

```{r, echo = FALSE, eval = TRUE, message=FALSE, warning=FALSE}
library(brms) # load the library
source("./ibswrfiles/brm_run.R")
brmfit_diamonds <- run_model(brm(bf(log_Price ~ log_Carats*(Color + Clarity)), diamond_data), "./brm_models_lectures/diamonds")
```
